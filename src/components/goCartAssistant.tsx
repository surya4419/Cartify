...
export const goCartAssistant: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-1 sm:p-2">
      <div className="bg-white rounded-2xl w-full max-w-screen-md h-[80vh] max-h-screen flex flex-col overflow-hidden shadow-2xl border-2 border-[rgb(99, 102, 241)]">
        {/* Fixed Header */}
        <div className="bg-gradient-to-r from-[rgb(99, 102, 241)] to-[rgb(79, 70, 229)] text-white px-3 py-2 sm:px-4 sm:py-3 flex items-center justify-between flex-shrink-0">
                  ...
                  {quickOptions.map((option) => (
                    <button
                      ...
                      onClick={() => handleQuickOption(option.id)}
                        className="p-2 border border-gray-200 rounded-xl hover:border-[rgb(99, 102, 241)] hover:bg-blue-50 transition-all text-left group shadow bg-white"
                    >
                        <div className="flex items-start space-x-2">
                          <span className="text-lg sm:text-xl">{option.icon}</span>
                        <div>
                            <div className="font-bold text-xs sm:text-sm text-gray-900 group-hover:text-[rgb(99, 102, 241)]">
                            {option.title}
                          </div>
              ...
              <div className="border-t bg-white p-2 sm:p-3 flex-shrink-0 shadow">
                ...
                <div className="flex-1 relative">
                  <input
                    ...
                    placeholder="Tell me what you need... (e.g., 'I want to cook biryani under $50')"
                      className="w-full px-3 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[rgb(99, 102, 241)] focus:border-transparent text-xs sm:text-sm"
                ...
                <button
                  ...
                  disabled={!input.trim() || isProcessing}
                    className="bg-[rgb(99, 102, 241)] text-white p-2 rounded-full hover:bg-[rgb(79, 70, 229)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow"
                >
              ...
              <div className="w-full lg:w-2/5 xl:w-1/3 bg-gray-50 flex flex-col border-t lg:border-t-0">
                    ...
                    />
                      ...
                      {product.name}
                        ...
                        <div className="flex items-center justify-between">
                          <span className="font-bold text-[rgb(99, 102, 241)] text-xs sm:text-sm">
                ...
                <button
                  onClick={addAllToCart}
                    className="w-full bg-[rgb(16, 185, 129)] text-black font-bold py-2 px-4 rounded-full hover:bg-yellow-300 transition-colors flex items-center justify-center space-x-2 shadow text-xs sm:text-sm"
                >
                ...
                <>
                  <div className="p-3 border-b bg-white flex-shrink-0 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="bg-[rgb(16, 185, 129)] text-black font-bold py-2 px-4 rounded-full hover:bg-yellow-300 transition-colors flex items-center space-x-2 shadow text-xs sm:text-sm"
