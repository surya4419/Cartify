    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full flex flex-col items-center">
          ...
          <h2 className="text-2xl font-bold text-indigo-600 mb-2">Payment Successful!</h2>
          ...
          <button
            onClick={() => navigate('/')}
            className="mt-6 w-full bg-emerald-500 text-white py-3 px-4 rounded-xl font-semibold text-sm hover:bg-emerald-600 transition-colors shadow"
          >
            Continue Shopping
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <form className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-xs"
                    required
                  />
                </div>
                <div>
          ...
          <div className="bg-white rounded-xl shadow p-3 space-y-3">
            ...
            <div className="border-t pt-2 flex items-center justify-between text-base font-bold">
              ...
              className="w-full bg-emerald-500 text-white py-3 px-4 rounded-xl font-semibold text-sm hover:bg-emerald-600 transition-colors shadow"
